                ...
                className={clsx(
                    "bg-gray-100 hover:bg-hero-texture-30 rounded-lg px-3 py-4 drop-shadow-md flex flex-col gap-1",
                    {
                        "border-2 border-pink-500":
                            index === activeIndex && !sidebar,
                        "bg-hero-skulls-10 hover:bg-hero-skulls-pink-30":
                            creature.hp <= 0,
            ...
            >
                ...
                <p className="flex flex-col @sm:flex-col @sm:gap-2 @md:flex-row @md:gap-5">
                    <span
                        onMouseOver={() =>
                            setTooltip(
                                "Use the creature's action for this round"
                            )
                        }
                    ...
                    >
                        ...
                        <input
                            ...
                            onChange={() =>
                                setCreatureAction(index, !creature.action)
                            }
                    ...
                    <span
                        onMouseOver={() =>
                            setTooltip(
                                "Use the creature's bonus action for this round"
                            )
                        }
                        className="flex flex-row items-center gap-1 cursor-pointer"
                    >
                        <label
                            htmlFor={bonusActionId}
                    ...
                    <span
                        onMouseOver={() =>
                            setTooltip(
                                "Use the creature's reaction for this round"
                            )
                        }
