      ...
      className={clsx(
        "h-10 font-bold rounded-full",
        {
          ...
          "px-4 text-white bg-gray-800 hover:shadow-md hover:shadow-pink-500/50":
            variant === "primary",
          "flex flex-row items-center text-center pl-4 pr-5 text-white bg-gray-800 hover:bg-gradient-to-r hover:from-emerald-400 hover:to-green-500":
            variant === "heal",
          "flex flex-row items-center text-center pl-4 pr-5 text-white bg-gray-800 hover:bg-gradient-to-l hover:from-pink-500 hover:to-rose-500":
            variant === "damage",
        },
        className,
      )}
